...
def create_question(question_text, days):
    ...
    published in the past, positive for questions that is yet to be published).
    ) 
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both and future questions exist, only past 
    ...
    def test_two_past_questions(self):
        ...
        question1 = create_question(question_text="Past question 1.",
                                    days=-30)
        question2 = create_question(question_text="Past question 1.",
                                    days=-30)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(
            response.context["latest_question_list"],
